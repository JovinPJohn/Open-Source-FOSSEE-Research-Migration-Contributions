...
| 2 | Priyanka | 4 |
| 2 | Subikeesh M | 4 |
| 2 | K S Madhavkrishnan | 4 |

## Open Source Projects (Officially Listed on FOSSEE)

| # | Project | Official FOSSEE Link | Year |
|---|---------|----------------------|------|
| 1 | 4-bit Baugh-Wooley Multiplier | [View on FOSSEE](https://esim.fossee.in/research-migration-project/research-migration-run/333) | 2025 |
...
Each project was designed, simulated, and verified using NgSpice within eSim, and is officially recorded as a completed open-source contribution to the eSim public library, freely reusable by students, researchers, and educators worldwide.

## Why Open Source

Contributing to eSim under FOSSEE means every circuit, schematic, and simulation in this repository is released as part of a free and open-source ecosystem — not locked behind proprietary licenses. This work is intended to lower the barrier to circuit design education and research, particularly for students and institutions who cannot afford commercial EDA tools.
